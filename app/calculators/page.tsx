...
export default function CalculatorsPage() {
  ...
  return (
    <main id="main-content" className="page-container directory-page">
      ...
      <section aria-labelledby="live-tools-heading" className="directory-section"><div className="section-heading"><p className="eyebrow">Available now</p><h2 id="live-tools-heading">Live tools</h2></div>{live.map((calculator) => <CalculatorCard calculator={calculator} key={calculator.slug} />)}</section>
